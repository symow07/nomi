...
/*
 * M34.8 — the five-step onboarding state machine (core/onboard/flow.ts) was
 * deleted. api/web/onboarding.ts is the live guided onboarding and derives each
 * step from real business data, keeping no progress store of its own.
 */
