...
| 7 | **Draft quality is good enough that owners would send them** (haiku-4-5 since 2026-09-18 — chosen on cost, this row is what checks the trade; our prompts, zh/ar/en) | Offline replay: ask 2–3 interviewees for 10 anonymized real threads; run through the pipeline (M0.5 creds needed); show drafts to the SAME owners: 「这条你会直接发吗?」 | ≥70% "would send" or minor edit | <50% → generation quality is the blocker; fix prompts/model BEFORE any pilot; a bad pilot burns the market | Wk 2 | **9 — gates the pilot** |
